...
![Cover](app/assets/cover-full.png)
...
![Figure 1: Ethical notice displayed at the top of every analysis output.](app/assets/ethical-note.png)
...
![Figure 2a: Score panel — Web Interface](app/assets/score-panel-tool.png)

![Figure 2b: Score panel — Command Line Interface](app/assets/score-panel-tool-cli.png)
...
![Figure 3: Classification breakdown donut chart.](app/assets/classification-breakdown.png)
...
![Figure 4: Co-author network graph (overview).](app/assets/co-author-network.png)

![Figure 5: Co-author network graph (detail).](app/assets/co-author-network2.png)
...
![Figure 6a: Classification summary — Web Interface](app/assets/classification-summary.png)

![Figure 6b: Classification summary — Command Line Interface](app/assets/classification-summary-cli.png)
...
![Figure 7a: Career trajectory chart — Web Interface](app/assets/career-trajectory.png)

![Figure 7b: Career trajectory chart — Command Line Interface](app/assets/career-trajectory-cli.png)
...
![Figure 8: Full citation table from the audit trail.](app/assets/citation-table.png)
...
![Figure 9: Comparison table.](app/assets/comparison-table.png)

![Figure 10: BARON trajectory comparison.](app/assets/baron-trajectory-comparison.png)

![Figure 11: HEROCON trajectory comparison.](app/assets/herocon-trajectory-comparison.png)

![Figure 12: Individual reports within the comparison view.](app/assets/individual-reports.png)
...
![Figure 13: The Citation-Constellation emblem](app/assets/cover-full.png)
...
where $w_i$ is the HEROCON weight for citation $i$'s classification, and "classifiable" excludes UNKNOWN citations (see [Section 6.6](#67-the-unknown-classification-and-data-quality-reporting)).
...
![Figure 14: Phased implementation architecture. Phases 1–3 are complete and available via CLI and web interface. Phase 4 (venue governance via local LLM) is under development. Phase 5 (field normalization) is planned.](app/assets/phased-architecture.png)
...
The exponential decay with rate 0.1 yields a half-life of approximately 7 years ($\ln(2)/0.1 \approx 6.93$). This reflects the hypothesis that recent collaborators are more "in-group" than distant ones. I note that the specific decay rate is not empirically grounded; alternative rates would be equally defensible. The decay function currently modulates co-authorship strength metadata logged in audit files but does not affect BARON classification (which uses binary in/out).
...
When affiliation data is insufficient for classification, citations are labeled `UNKNOWN` (see [Section 6.6](#67-the-unknown-classification-and-data-quality-reporting)).
...
![Figure 15: Development roadmap. Phase 4 introduces venue governance detection via a three-tool ecosystem (Pulsar, Astrolabe, Constellation). Phase 5 adds field normalization and comparative analytics. Phase 6 focuses on empirical validation and multi-source data fusion.](app/assets/project-plan.png)
